...
public class JdbcRewardRepository implements RewardRepository {
	...
	public RewardConfirmation confirmReward(AccountContribution contribution, Dining dining) {
		...
		BigDecimal rewardAmount = contribution.getAmount().asBigDecimal();
		Date rewardDate = new Date(SimpleDate.today().inMilliseconds());
		String accountNumber = contribution.getAccountNumber();
		String diningMerchantNumber = dining.getMerchantNumber();
		Date diningDate = new Date(dining.getDate().inMilliseconds());
		BigDecimal diningAmount = dining.getAmount().asBigDecimal();


		jdbcTemplate.update(sql, confirmationNumber,rewardAmount, rewardDate, accountNumber, diningMerchantNumber, diningDate, diningAmount);
